...
const SearchForm = () => {
  return (
    <form
      className="flex items-center justify-between mb-8 bg-white pl-6  md:pl-8 pr-4 py-4 
    ...
    >
      <div className="flex items-center space-x-4 w-full">
        ...
        <input
          className="font-base caret-violet md:border-r pr-2 md:py-5 text-very_dark_blue w-full outline-none  placeholder:text-base placeholder:text-grey"
      ...
      <div className="  hidden md:flex md:items-center space-x-4 w-full ">
        ...
        <input
          className="font-base w-full caret-violet md:border-r pr-2 md:py-5 text-very_dark_blue outline-none placeholder:text-base placeholder:text-grey"
      ...
      <div className=" hidden md:flex md:items-center space-x-4 text-nowrap ">
        <input
          className="bg-grey w-6 h-6 caret-violet"
          type="checkbox"
          name=""
          id="checkbox"
        />
        <label
          className="text-base text-very_dark_blue font-bold"
          htmlFor="checkbox"
        >
          Full Time
        </label>
